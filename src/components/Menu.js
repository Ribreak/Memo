            ...
            <div className="menu__settings settings">
                ...
                <div className="settings__list">
                    <input id="radio12" 
                        ...
                        name="numberOfTiles" 
                        value="12" 
                        defaultChecked={props.checkedOption === 12} 
                    ...
                    <input id="radio16" 
                        ...
                        name="numberOfTiles" 
                        value="16" 
                        defaultChecked={props.checkedOption === 16} 
                        onChange={props.onRadioChange} /> 
                    ...
                    <input id="radio32" 
                        ...
                        name="numberOfTiles" 
                        value="32" 
                        defaultChecked={props.checkedOption === 32} 
                        onChange={props.onRadioChange} /> 
                    <label htmlFor="radio32">32</label>
                </div>
            </div>
            <button className="menu__start-button button" onClick={props.onClickStart}>Начать игру</button>
        </div>
    )
}